...
import cyberTopicsByLocale from "./data";
...
const CyberSafetyTopics = () => {
  ...
  const topics = cyberTopicsByLocale[locale];
...
const styles = StyleSheet.create({
  ...
  row: { justifyContent: "space-between", marginBottom: verticalScale(18) },
  card: {
    flex: 1,
...
export default CyberSafetyTopics;
