...
import investmentTipsByLocale from "./data"; // replace './data' if filename differs
...
const InvestmentTips = () => {
  ...
  const [selectedTip, setSelectedTip] = useState<Item | null>(null);
  ...
  return (
    <AppSafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.mainContainer}>
        ...
        <Text style={styles.subHeader}>{t("Tap to learn about each tip")}</Text>
        <FlatList
          data={tips}
          numColumns={2}
